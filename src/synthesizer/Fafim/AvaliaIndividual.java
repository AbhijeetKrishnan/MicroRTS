...
public class AvaliaIndividual extends Thread {
    ...
    public AvaliaIndividual(iDSL sIA1, List<iDSL> sIA2, int play, GameState gs, UnitTypeTable utt, int limite,
            int op_mutacao) {
        this.sIA1 = sIA1;
        this.sIA2 = sIA2;
    ...
    public int execute() throws Exception {
        ...
        if (op_mutacao == 0)
            sIA1 = (iDSL) sIA1.clone();
        if (op_mutacao == 1)
            sIA1 = BuilderDSLTreeSingleton.changeNeighbourPassively((iDSL) sIA1.clone());
